<aside
    class="sidenav shadow navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps alert-white"
    id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">THUNDERSUPER<span class="text-primary">BIKE</span>
                <small>(ระบบจัดการข้อมูล)</small></span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('storage') ? 'active' : '' }}" href="{{ url('storage') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-lg fa-store-alt ps-2 pe-2 text-center text-dark {{ Request::is('storage') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('member') ? 'active' : '' }}" href="{{ url('member') }}">
                    ...
                    <span class="nav-link-text ms-1">ข้อมูลลูกค้า</span>
                </a>
            </li>
            <li class="nav-item mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('role') ? 'active' : '' }}" href="{{ url('role') }}">
                    ...
                    <span class="nav-link-text ms-1">บทบาทหน้าที่</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('users') ? 'active' : '' }}" href="{{ url('users') }}">
                    ...
                    <span class="nav-link-text ms-1">รายการผู้ดูแล</span>
                </a>
            </li>
        </ul>
    </div>
