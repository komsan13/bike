<aside class="sidenav shadow navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      ...
      <span class="ms-3 font-weight-bold">WEBPANEL (thundersuperbike)</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
          ...
          <span class="nav-link-text ms-1">ลงทะเบียนรถ</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('billing') ? 'active' : '') }}" href="{{ url('billing') }}">
          ...
          <span class="nav-link-text ms-1">ตรวจสอบสต๊อก</span>
        </a>
      </li>
      <li class="nav-item mt-2">
